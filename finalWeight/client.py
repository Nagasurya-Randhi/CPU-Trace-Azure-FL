...
class TimeSeriesClient(fl.client.NumPyClient):
    ...
    def fit(self, parameters, config):
        ...
        for file in self.csv_files:
            ...
            total_train_mse += train_mse * len(y_train)
            total_train_rmse += train_rmse * len(y_train)
            total_train_mae += train_mae * len(y_train)
