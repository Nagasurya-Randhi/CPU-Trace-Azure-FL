import numpy as np
from tensorflow.keras.layers import Input, LSTM, GRU, Bidirectional, Conv1D, MaxPooling1D, Dropout, Dense, Activation, Flatten, RepeatVector, Permute, multiply, Lambda
